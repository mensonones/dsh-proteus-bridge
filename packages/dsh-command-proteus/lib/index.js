...
5. Provision any recon tool you need (httpx, naabu, nuclei, ffuf, ...) on demand — announce which tool and why, install it (prefer no-sudo static binaries), then use it.
